...
def get_receipt_department(master: dict, departments_page: dict, page: int) -> InlineKeyboardMarkup:
    keyboard = get_back()
    permissions = tools.permissions(master)
...
def get_receipts(master: dict, receipts_page: dict, page: int, department) -> InlineKeyboardMarkup:
...
def kb_get_create_department(master: dict,
                             departments_page: dict,
                             action: str,
                             page: int,
                             receipt_id) -> InlineKeyboardMarkup:
...
def kb_add_product(master, products_page, receipt_id, page, remainings=[]) -> InlineKeyboardMarkup:
    keyboard = InlineKeyboardMarkup()
    permissions = tools.permissions(master)
